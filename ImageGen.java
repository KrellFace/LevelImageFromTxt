...
public class ImageGen {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Loop through every file to create images
        for (int fileNum = 0; fileNum<files.length; fileNum++) {
        	//Store selected file name for output naming
        	String fileName = files[fileNum].getName();
        
	    	BufferedReader br = new BufferedReader(new FileReader(files[fileNum])); 
	    	...
	    	//Refresh buffer
	    	br = new BufferedReader(new FileReader(files[fileNum])); 
	    	st = br.readLine();
	    	...
	    	// Save as JPEG
	    	File imageFileJPEG = new File(defaultOutputDir+fileName+"JPG.jpg");
